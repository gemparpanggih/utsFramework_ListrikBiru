...
<body>
	...
	<h2><a href="#">Tarif</a></h2>
	<h3>Data Tarif</h3>

	<a href="/tarif"> Kembali</a>
	...
	<form action="/tarif/store" method="post">
		{{ csrf_field() }}
		Kodetarif <input type="text" name="kodetarif"> <br/>
		Voltase <input type="text" name="voltase"> <br/>
		Biaya <input type="number" name="biaya"> <br/>
